...
wb = openpyxl.load_workbook('/Users/kittiphongthabutda/Documents/RobotFramworkPractice/test_data/test_scenario_krungsri.xlsx')
...
def get_data_personal_loan_apply_page(choose):
...
# print(get_data_personal_loan_apply_page('name'))